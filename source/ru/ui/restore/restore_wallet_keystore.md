title: Восстановление кошелька из файла хранилища
---
...
4. Восстановите учётные записи из файла хранилища

<img src="/images/restore_from_keystore/restore_from_keystore_4.png">

5. Выберите учётные записи, которые необходимо восстановить

<img src="/images/restore_from_keystore/restore_from_keystore_5.png">

6. Проверьте результаты этой процедуры. Существующие учётные записи не будут затронуты.
