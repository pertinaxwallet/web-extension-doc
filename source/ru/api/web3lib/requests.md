...
# Web3-подобная библиотека запросов API основанная на EVERIP-32 (ранее TIP-32) стандарте

Веб-расширение позволяет взаимодействовать с DApp (децентрализованное приложение) на основе EVERIP-32 (ранее TIP-32) стандарта. Полная спецификация доступна [здесь](https://docs.google.com/document/u/1/d/1NVSznTRUEZ53rj8je9xdXZbcyHIybURlcGtCQAoHhuo).
...
DApp может выполнять EVERSCALE SDK методы напрямую по схеме которая описана в EVERIP-32 (ранее TIP-32):
...
Все методы EVERSCALE SDK и методы из спецификации EVERIP-32 (ранее TIP-32) доступны для тестирования на [демо странице](https://everip32-demopage.pertinaxwallet.com/)
